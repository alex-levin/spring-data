...
public class QueryDemos {
    ...
    public void pagingAndSortingQueries() {
        ...
        // We want the first page with 4 records on it
        // 0 = the page number (0 is the first page)
        // 4 = size of the page
    ...
    public void queryByExample() {
        System.out.println("\nFind the Department with the name 'Humanities' \n" +
                // Constructing department with name "Humanities"
        ...
        departmentRepository.findAll(Example.of(
                // Constructing Department with name is null and Person John
